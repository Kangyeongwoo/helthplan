...
public class RecyclerViewAdapter_noticeregister2 extends RecyclerView.Adapter<RecyclerViewAdapter_noticeregister2.ViewHolder>{
    ...
    RecyclerViewAdapter_noticeregister2(Context context , ArrayList<String> items, HashMap<String, ArrayList<String>> hashmapactionname , HashMap<String, ArrayList<String>> hashmapactionset, HashMap<String,String> resttimelist, int itemLayout ){
    ...
    public ViewHolder onCreateViewHolder( ViewGroup parent, int viewType) {
        ...
        return new RecyclerViewAdapter_noticeregister2.ViewHolder(v);
    }
